class MongoDB {
    ...
    async LeftAverageData() {
        ...
        console.log(MinsEnd)
        Avg_CO2 = await this.avgPower('CO2',MinsStart, MinsEnd);
        Avg_humid = await this.avgPower('Humidity',MinsStart, MinsEnd);
        Avg_temp = await this.avgPower('Temperature',MinsStart, MinsEnd);
    ...
    async StorageAverageData() {
        ...
        console.log(MinsEnd)
        Avg_CO2 = await this.avgPower('CO2',MinsStart, MinsEnd);
        Avg_humid = await this.avgPower('humid',MinsStart, MinsEnd);
        Avg_temp = await this.avgPower('tempareture',MinsStart, MinsEnd);
        // sum = powerMeterPower + upsPower_A + upsPower_B;
        let piePercent = [
            Avg_CO2,
            Avg_humid,
